...
class ModifyBillService extends BaseService
{
	public $url = "https://api.mch.weixin.qq.com/v3/payscore/serviceorder/{out_order_no}/modify";
	...
	protected function getDefault () : array
	{
		...
		return [
			"out_order_no", "post_payments", "total_amount", "reason"
		];
	}
	...
	protected function getArrayField () : array
	{
		...
		return [ "post_payments", "post_discounts" ];
	}
